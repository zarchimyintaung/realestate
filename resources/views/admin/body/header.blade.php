        ...
        <li class="nav-item nav-profile dropdown">
          <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
            <div class="nav-profile-img">
                <img src="{{(!empty($profileData->photo)) ? url('upload/admin_images/'.$profileData->photo) :  url( '/upload/face26.jpg')}}" style="width: 30px;height:30px" class="wd-100 rounded-circle" style="width: 100px;height:100px" alt="profile">
              <span class="availability-status online"></span>
            </div>
            <div class="nav-profile-text">
              <p class="mb-1 text-black">{{$profileData->name}}</p>
            </div>
          </a>
          <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
            ...
            <a class="dropdown-item" href="#">
              <i class="mdi mdi-cached me-2 text-success"></i>Switch User
            </a>
